...
for loss_type in dr_grpo; do
    RUN_NAME="${dataset_name}_${PROMPT_TYPE}_metadata_reward_${loss_type}_seed${seed}_k1000_128_steps${max_steps}_temp${temp}_lr1e-6"
