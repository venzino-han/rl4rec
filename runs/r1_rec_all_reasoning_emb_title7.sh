...
for target_emb_coef in 0.2; do
for loss_type in dr_grpo ; do
echo "Training ${dataset_name}..."
for lr in 2e-6 5e-6; do
for temp in 0.6 ; do
RUN_NAME="${loss_type}_${dataset_name}_seq_rec_reasoning_emb_title_${target_emb_coef}_temp${temp}_1000_lr${lr}"
