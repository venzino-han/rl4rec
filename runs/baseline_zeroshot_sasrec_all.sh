...
# Script to run zeroshot evaluation with SASRec recommendations
...
for data_name in "${data_names[@]}"; do
    for prompt_type in "${prompt_types[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=$DEVICE python3 src/train_sft.py \
            ...
            --use_brand \
            --use_category \
            --target_type item_preference_1024_gemma-3-4b-it \
            --max_steps $MAX_STEPS \
...
echo "✅ All zeroshot evaluations with SASRec completed!"
