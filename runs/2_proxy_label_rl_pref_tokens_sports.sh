...
for loss_type in dr_grpo; do
    RUN_NAME="${dataset_name}_${PROMPT_TYPE}_proxy_label_30_0.7_rank_${loss_type}_seed${seed}_k1000_128_steps${max_steps}_temp${temp}_lr1e-6"
    ...
    CUDA_VISIBLE_DEVICES=$device python3 src/grpo_train.py \
        ...
        --proxy_label_reward \
        --proxy_k 30 \
        --proxy_label_coef 0.7 \
        --rank_min 0 \
        --rank_max 2000 \
        --filter_train_csv results/sports_seq_rec_new_baseline_zeroshot_test_eval_20260128_204225.csv \
        --max_new_tokens 128 \
        --num_epochs 1 \
        --batch_size 32 \
        --learning_rate 1e-6 \
